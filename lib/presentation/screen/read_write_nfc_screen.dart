...
import 'package:minwoo/core/notifilter/nfc_notifiler.dart';
import 'package:minwoo/presentation/widgets/dialogs.dart';
                  ...
                  Consumer<NFCNotifier>(builder: (context, provider, _) {
                    ...
                    if (provider.message.isNotEmpty) {
                      WidgetsBinding.instance.addPostFrameCallback((_) {
                        ...
                        showReulstDialog(context, provider.message);
                      });
                    }
